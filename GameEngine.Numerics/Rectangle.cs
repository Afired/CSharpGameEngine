...
namespace GameEngine.Numerics
{
    ...
    public struct Rectangle : IEquatable<Rectangle>
    {
        ...
        /// </summary>
        [Serialized] public int Y;

        /// <summary>
        /// The width of this <see cref="Rectangle"/>.
        /// </summary>
        [Serialized] public int Width;

        /// <summary>
        /// The height of this <see cref="Rectangle"/>.
        /// </summary>
        [Serialized] public int Height;
        ...
        /// <summary>
        /// Gets whether or not the provided <see cref="Vec2{T}"/> lies within the bounds of this <see cref="Rectangle"/>.
        /// </summary>
        /// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
        /// <returns><c>true</c> if the provided <see cref="Vec2{T}"/> lies inside this <see cref="Rectangle"/>; <c>false</c> otherwise.</returns>
        public bool Contains<T>(Vec2<T> value) where T : struct, IFloatingPointIeee754<T>
        {
            return ((((this.X <= float.CreateChecked(value.X)) && (float.CreateChecked(value.X) < (this.X + this.Width))) && (this.Y <= float.CreateChecked(value.Y))) && (float.CreateChecked(value.Y) < (this.Y + this.Height)));
        }
        ...
        /// </summary>
        /// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
        /// <param name="result"><c>true</c> if the provided <see cref="Vec2{T}"/> lies inside this <see cref="Rectangle"/>; <c>false</c> otherwise. As an output parameter.</param>
        public void Contains<T>(ref Vec2<T> value, out bool result) where T : struct, IFloatingPointIeee754<T>
        {
            result = ((((this.X <= float.CreateChecked(value.X)) && (float.CreateChecked(value.X) < (this.X + this.Width))) && (this.Y <= float.CreateChecked(value.Y))) && (float.CreateChecked(value.Y) < (this.Y + this.Height)));
        }
        ...
        /// </summary>
        /// <param name="amount">The x and y components to add to this <see cref="Rectangle"/>.</param>
        public void Offset<T>(Vec2<T> amount) where T : struct, IFloatingPointIeee754<T>
        {
            X += int.CreateChecked(amount.X);
            Y += int.CreateChecked(amount.Y);
        }
